...
def usage ():
		print "\n\tUsage:"
		print "\t\trazr.py -d{d,s} [Parameter]"
		print "\t\trazr.py -d{e,g,l,p,u} "
		print "\t\trazr.py -a{a,b,c,d,f i,l,m,p,q,s,x} [App]"
		print "\t\trazr.py -l{l,m} [App]"
		print "\t\trazr.py -s{a,c,m} {App} [Activity|Content Provider|Count]"
		print "\t\trazr.py -si {Action} [App/Receiver]"
		print "\t\trazr.py -ss {Service} {Code}"
		print "\t\trazr.py -s{u|t} {USSD Code | Secret Code}"
		print "\t\trazr.py -s{d|k}"
		print "\n\tDevice Enumeration"
